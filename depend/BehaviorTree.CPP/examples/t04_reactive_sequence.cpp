 ...
 *
 *  - The difference between Sequence and PersistentSequence
 *
...
int main()
{
    ...
    //  2) When PersistentSequence is used, those ConditionNodes are executed only __once__.
